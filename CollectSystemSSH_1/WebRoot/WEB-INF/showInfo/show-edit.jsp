...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		//科技活动类型填写的规则**********************************************************
   		$(function(){
   			$("input[value='基础研究']").change(function(){
   				//alert("hhh1");
   			 ...
   			 $("input[value='应用研究'],input[value='试验发展'],input[value='研究发展与成果应用'],input[value='技术推广与科技服务'],input[value='生产性活动']").change(function(){
   				//alert("hhh2");
  ...
  <body>
    	...
    	<s:form action="show-editSave" method="post">
    		<table width="900" height="1224" border="1" align="center" cellspacing="0">
				...
				<tr>
  				...
  				<tr>
    				...
    				<td colspan="4" align="center" valign="middle">
        				<s:radio list="#{'基础研究':'基础研究','应用研究':'应用研究','试验发展':'试验发展','研究发展与成果应用':'研究发展与成果应用','技术推广与科技服务':'技术推广与科技服务','生产性活动 ':'生产性活动 '}"  
        				name="t_Type" /> </td>
  				</tr>  
  				...
  				<tr id="tr_subject" style="display:none;">									
    				...
    				<td colspan="4" align="center" valign="middle">   		
    					  <s:select list="#request.listFirstsEdit"
							listKey="listFirstId" listValue="listFirstName" name="listFirst.listFirstId" id="list1" headerKey="0" headerValue="--请选择--">				
						</s:select>	 		
						<s:select list="#request.listSecondsEdit"
							 listKey="listSecondId" listValue="listSecondoName" name="listSecond.listSecondId" id="list2"  headerKey="0" headerValue="--请选择--"  multiple="false"/>
						<s:select list="#request.listThirdsEdit"
							 listKey="listThirdId" listValue="listThirdName" name="listThird.listThirdId" id="list3"  headerKey="0" headerValue="--请选择--"  multiple="false"/>
    			...
    			<tr id="tr_skillTrade" style="display:none;">
					...
					<td colspan="4" align="center" valign="middle">
						 ...
						 <s:select list="#request.tradeFirstsEdit"
							listKey="tradeFirstId" listValue="tradeFirstName" name="tradeFirst.tradeFirstId" id="trade1" headerKey="0" headerValue="--请选择--">				
						</s:select>
						<s:select list="#request.tradeSecondsEdit"
							listKey="tradeSecondId" listValue="tradeSecondName" name="tradeSecond.tradeSecondId" id="trade2"  headerKey="0" headerValue="--请选择--"  multiple="false"/>
						<s:select list="#request.tradeThirdsEdit"
						 	listKey="tradeThirdId" listValue="tradeThirdName" name="tradeThird.tradeThirdId" id="trade3"  headerKey="0" headerValue="--请选择--"  multiple="false"/>
					 
					</td>
				</tr>
			<s:hidden name="user_IdS" value="%{#session.user_Id}"/>
			<s:hidden name="skill_Id" value="%{#session.skill_Id}"/>
    		</table>
    		<center>
			<br>
