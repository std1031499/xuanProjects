...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <%
        	...
        	Object user_Id = webSession.getAttribute("user_Id");
                            ...
                            <div id="rbox_middlecenter">
                                <div id="rbox_middleleft">
                                    <div id="rbox_middleright">
                                        <div id="bs_right">
                                            <IFRAME scrolling="yes" height="100%" width="100%" frameBorder=0 id=frmright name=frmright src="emp-systemIntro" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                                    </div>
                                </div>
