                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <s:form action="sender-addSenderSave" method="post">
                                        <div class="form-group" >
                                        	<table class="tablecss">                                        		                                        		
	                                            <tr>
	                                            	 <tr>
	                                            	<td><label style="width:100px">服务商ID：</label></td>
	                                            	<td><s:textfield  value="%{#session.userId}" cssClass="form-control" style="width:275px;" disabled="true" /></td>
	                                            	
	                                        	</tr>
		                                        <tr>
	                                            	 <tr>
	                                            	<td><label style="width:100px">服务商名称：</label></td>
	                                            	<td><s:textfield  value="%{#request.senderOfCompanyName}" cssClass="form-control" style="width:275px" disabled="true" /></td>
