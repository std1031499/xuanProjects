...
// 			var val = $("#chartType").val();
			var year = $("#customerAreaYear").val();
			var url = "dataOutput-areaBar";
			var args = {customerAreaYear:year,"time":new Date()};
	...
	function areaResult(Data){ 
		...
		//获取选择年份
		var customerAreaYear = $("#customerAreaYear").val();
		
		$tr = '';
		$tr+="<tr><td>"+customerAreaYear+"年客户地区分布 ："+goodArea[goodArea.length-1][0]+"、"+goodArea[goodArea.length-2][0]+"、"+goodArea[goodArea.length-3][0]+"</td></tr>";
	    //数据结果
		...
		$tr = '';
		$tr = "<tr><td>建议：</td></tr>";
 		$tr+="<tr><td>&nbsp&nbsp 在&nbsp&nbsp<a style='color:red'>"+goodArea[0][0]+"、"+goodArea[1][0]+"、"+goodArea[2][0]+"</a>&nbsp&nbsp地区进行少量的囤货，该区域进行交易次数少</td></tr>";
		$tr+="<tr><td>&nbsp&nbsp 在&nbsp&nbsp<a style='color:red'>"+goodArea[goodArea.length-1][0]+"、"+goodArea[goodArea.length-2][0]+"、"+goodArea[goodArea.length-3][0]+"</a>&nbsp&nbsp地区进行大量的囤货，该区域进行交易次数多"+"</td></tr>";
  		...
  		<div >
            <div id="page-inner">
               ...
               <div class="form-group" >
               		...
               		<s:select style="width:275px" id="customerAreaYear" cssClass="form-control"  list="{'2010','2011','2012','2013','2014','2015','2016','2017','2018','2019'}" headerKey="-1" headerValue="--请选择年份--"  multiple="false"/>
  					<br>
