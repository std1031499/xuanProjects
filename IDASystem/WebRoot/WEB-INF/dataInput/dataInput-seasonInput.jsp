...
<html>
  <head>
	...
	function line(Data){
		...
		inputMoneyData.pointColor = "rgba(151,187,205,1)";
		inputMoneyData.pointStrokeColor ="#fff";
		//alert("h3"); 
	...
	$(function () {
		...
		$("#show").click(function(){
			...
			var url = "dataInput-chartLine";
			var args = {"chartType":val,seasonYear:year,"time":new Date()};
	...
	function seasonResult(Data){
		...
		$tr = '';
		$tr+="<tr><td>"+seasonYear+"年"+moneyMaxMonth+"月&nbsp&nbsp有最大进项金额："+moneyMax+"元 </td>";
		$tr+="<td>"+seasonYear+"年"+moneyMinMonth+"月&nbsp&nbsp有最小进项金额："+moneyMin+"元 </td></tr>";
		$tr+="<tr><td>"+seasonYear+"年"+taxMaxMonth+"月&nbsp&nbsp有最大进项税金："+taxMax+"元 </td>";
		$tr+="<td>"+seasonYear+"年"+taxMinMonth+"月&nbsp&nbsp有最小进项税金："+taxMin+"元 </td></tr>";
		$tr+="<tr><td>"+seasonYear+"年"+sumMaxMonth+"月&nbsp&nbsp有最大进项价税合计金额："+sumMax+"元 </td>";
		$tr+="<td>"+seasonYear+"年"+sumMinMonth+"月&nbsp&nbsp有最小进项价税合计金额："+sumMin+"元 </td></tr>";
		$tr+="<tr><td>"+seasonYear+"年销售进项："+badSeason[9][0]+"、"+badSeason[10][0]+"、"+badSeason[11][0]+"月"+"</td></tr>";
		$tr+="<tr><td>"+seasonYear+"年销售进项："+badSeason[0][0]+"、"+badSeason[1][0]+"、"+badSeason[2][0]+"月"+"</td></tr>";
	    //数据结果
		...
		$tr = '';
		$tr = "<tr><td>建议：</td></tr>";
		$tr+="<tr><td>&nbsp&nbsp 在"+badSeason[9][0]+"、"+badSeason[10][0]+"、"+badSeason[11][0]+"月进行大量的进货，此时进货量大"+"</td></tr>";
		$tr+="<tr><td>&nbsp&nbsp 在"+badSeason[0][0]+"、"+badSeason[1][0]+"、"+badSeason[2][0]+"月进行少量量的进货，此时进货量小"+"</td></tr>";
