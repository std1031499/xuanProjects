						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">企业增值税发票数据</span><br>
									<span class="red" id="id-text2">分析系统</span>
								</h1>
								<br>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<!-- form开始 -->
											<s:form action="manage-loginCheck" method="post">
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<s:textfield name="manageUsername" cssClass="form-control"  placeholder="Username" />
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<s:textfield name="managePassword" type="password" cssClass="form-control" placeholder="Password" />
								...
								<div id="signup-box" class="signup-box widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<s:form action="manage-registerSave" method="post">
												<fieldset>
													

													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<s:textfield name="manageUsername" cssClass="form-control" placeholder="用户名" />
															<i class="ace-icon fa fa-user"></i>
														</span>
													</label>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<s:textfield name="managePassword" type="password" cssClass="form-control" placeholder="密码" />
															<i class="ace-icon fa fa-lock"></i>
														</span>
													</label>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<s:textfield name="managePasswordSure"  type="password" cssClass="form-control" placeholder="确认密码" />
